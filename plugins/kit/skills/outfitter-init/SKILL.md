...
|--------|----------|-----------|
| No package.json | **New Project** | → [New Project Scaffolding](#new-project-scaffolding) |
| Has package.json | **Existing Project** | → [Migration Workflow](#migration-workflow) |
...
3. Reference fieldguide for conversion patterns:
   - **Throws → Result**: [patterns/conversion.md](../outfitter-fieldguide/patterns/conversion.md)
   - **Error taxonomy**: [patterns/errors.md](../outfitter-fieldguide/patterns/errors.md)
   - **Logging**: [patterns/logging.md](../outfitter-fieldguide/patterns/logging.md)
   - **Templates**: [templates/](../outfitter-fieldguide/templates/)
